      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div className={styles.top}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.brandDesc}>
              Web Developer passionate about building beautiful and functional digital experiences.
            </p>
            <div className={styles.socials}>
              ...
              <a href="mailto:muhammadfarhan8743@gmail.com" className={styles.social} aria-label="Email">
          ...
          <div className={styles.col}>
            ...
            <ul className={styles.navList}>
              {['Web Design', 'Web Development', 'Database Management', 'Admin Dashboard', 'Website Maintenance', 'Responsive Website'].map(s => (
                <li key={s}>
                  <a href="#services" className={styles.navLink} onClick={e => { e.preventDefault(); scrollTo('services') }}>
                    <span className={styles.navArrow}>→</span>
                    {s}
                  </a>
                </li>
          ...
          <div className={styles.col}>
            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.contactRow}>
                <span>📱</span>
                <a href="tel:+6289618952022">+62 896-1895-2022</a>
              </div>
              <div className={styles.contactRow}>
                <span>✉️</span>
                <a href="mailto:muhammadfarhan8743@gmail.com">muhammadfarhan8743@gmail.com</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {year} Mochamad Farhan Ferdiansyah. All rights reserved.
          </p>
