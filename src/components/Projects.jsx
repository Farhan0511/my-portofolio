...
const projects = [
  ...
  },
  {
    ...
    title: "Notes App",
    category: "Web App",
    desc: "Aplikasi pencatat berbasis web yang memungkinkan pengguna membuat, mengedit, menghapus, dan mengelola catatan dengan mudah. Dibangun menggunakan HTML, CSS, dan JavaScript dengan antarmuka yang sederhana, responsif, dan mudah digunakan.",
    tech: ["HTML", "CSS", "JavaScript"],
    color: "#8b5cf6",
    emoji: "📝",
    demo: "#",
  ...
  },
  {
    ...
    category: "Web App",
    desc: "Dashboard admin berbasis web yang digunakan untuk mengelola data pengguna, produk, pesanan, dan laporan. Dilengkapi dengan fitur CRUD, autentikasi login, pencarian data, serta tampilan dashboard yang responsif untuk memudahkan pengelolaan sistem.",
    tech: ["Laravel", "PHP", "MySQL", "Bootstrap"],
    color: "#14b8a6",
    emoji: "📊",
    demo: "#",
